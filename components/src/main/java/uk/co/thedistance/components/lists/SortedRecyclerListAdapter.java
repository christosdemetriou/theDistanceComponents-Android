...
public class SortedRecyclerListAdapter<T> extends SortedListDelegationAdapter<SortedList<T>> {
    ...
    public SortedRecyclerListAdapter(Class<T> clazz, final Sorter<T> sorter) {
        this.sorter = sorter;
