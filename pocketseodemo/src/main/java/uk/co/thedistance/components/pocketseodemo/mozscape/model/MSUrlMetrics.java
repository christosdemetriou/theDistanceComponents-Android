...
package uk.co.thedistance.components.pocketseodemo.mozscape.model;

import com.google.gson.annotations.SerializedName;

import java.util.Date;

import uk.co.thedistance.components.pocketseodemo.model.MozScape;
...
public class MSUrlMetrics implements MozScape {
    ...
    @Override public boolean isSameItem(ListSortable other) {
        return false;
    }
